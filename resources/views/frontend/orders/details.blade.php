...
<head>
	<meta charset="UTF-8">
	<title>UTSHOV...always be happy and spread your happiness</title>
    	...
    	<div class="invoice overflow-auto">
        	<div style="min-width: 600px">
	            <header>
	                <div class="row">
	                    <div class="col">
	                        <a target="_blank" href="https://uthsov.com">
	                            <img src="{{asset('frontend/img/logo.png')}}" data-holder-rendered="true" width="230px" />
                            </a>
	                    </div>
