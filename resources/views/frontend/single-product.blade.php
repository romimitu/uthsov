          ...
          <div class="details item col-lg-6">
            ...
            <ul class="price list-inline no-margin">
                ...
                @if($item->productDetail->count() == 1)
                  Tk. {{$item->productDetail->max('sales_price')}}
                @elseif($item->productDetail->count() > 1)
          Tk. {{$item->productDetail->min('sales_price')}} - {{$item->productDetail->max('sales_price')}}
                @endif
                </li>
            ...
            <div class="product is-gray">
              <div class="image d-flex align-items-center justify-content-center">
                ...
                @if($product->image->count() > 0)
              	<img src="/uploads/product/{{$product->image[0]->image}}" alt="..." class="img-fluid">
                @endif
